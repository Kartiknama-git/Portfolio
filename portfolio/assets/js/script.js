...
class PortfolioApp {
    ...
    applyTheme() {
        ...
        if (this.isDarkTheme) {
            ...
            if (profileImage) {
                this.switchProfileImage(profileImage, './assets/ele/kartik1.png', 'Kartik Nama - Developer Illustration (Dark Theme)', 'brightness(0.7) contrast(1.1) hue-rotate(0) saturate(1)');
                // this.switchProfileImage(profileImage, './assets/ele/kartik1.png', 'Kartik Nama - Developer Illustration (Dark Theme)', 'brightness(0.7) contrast(1.1) hue-rotate(0) saturate(1)');
                // this.switchProfileImage(profileImage, './assets/ele/kartik1.png', 'Kartik Nama - Developer Illustration (Dark Theme)', 'none');
            ...
            if (profileImage) {
                // this.switchProfileImage(profileImage, './assets/ele/kartik.png', 'Kartik Nama - Developer Illustration (Light Theme)', 'none');
                this.switchProfileImage(profileImage, './assets/ele/kartik.png', 'Kartik Nama - Developer Illustration (Light Theme)', 'none');
            }
        }
    ...
    handleContactForm(e) {
        ...
        fetch('/', {
            ...
            .catch((error) => {
                ...
                this.showNotification('❌ Failed to send message. Please try emailing me directly at namakartik32@gmail.com', 'error');
            })
            .finally(() => {
